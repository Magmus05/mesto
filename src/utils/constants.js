...
export const cardName = document.querySelector('.popup_type_createCard').querySelector('.popup__text_type_name-card');
export const cardLink = document.querySelector('.popup_type_createCard').querySelector('.popup__text_type_link-card');
...
export const nameImagePopupFoto = document.querySelector('.popup-foto__image-name');
